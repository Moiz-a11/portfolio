...
<h2 className='form-title offset-5'style={{ color: "white" }} >Drop Massege  </h2>
         <div  className=" mt-5 offset-4 drop-msg-container card d-flex flex-column align-items-center justify-content-center socials ">
                       {/*   Drop Massege  */}

                 
                <div className="lable-input-container mt-3"> 
  <label className="mb-2 form-lable" htmlFor="name">Name </label>
          ...
          <label className="mb-2 form-lable" htmlFor="email">Email </label>
            ...
            <input name="email" className="mb-2"  type="email" placeholder="email" />
             ...
             <textarea name="msg"  rows="4" cols="30" id=""></textarea> 
